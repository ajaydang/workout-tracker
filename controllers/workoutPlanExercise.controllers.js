...
exports.getWorkoutPlanExerciseById = async function (req, res, next) {
    ...
    try {
        ...
        res.json({
            status: 200,
            data: workoutPlanExerciseByIdData,
...
exports.getWorkoutPlanExerciseByUserId = async function (req, res, next) {
    ...
    try {
        const workoutPlanExerciseByUserId = await workoutPlanExerciseServices.getWorkoutPlanExerciseByUserId(
            Number(uid)
        );

        res.json({
            status: 200,
            data: workoutPlanExerciseByUserId,
            message: 'Retrieved Success',
        });
    } catch (error) {
        next(error);
...
exports.updateWorkoutPlanExerciseById = async function (req, res, next) {
    ...
    try {
        const updateWorkoutPlanExerciseData = await workoutPlanExerciseServices.updateWorkoutPlanExerciseById(
            req.body,
            id
        );
        ...
        res.json({
            status: 200,
            data: updateWorkoutPlanExerciseData,
